    ...
    >
      ...
      <div className={cn("space-y-10 transition-all duration-500", isSenior && "elder-mode")}>
        ...
        <div className={cn(
          ...
          {/* Budget Card */}
          <Link href="/mariage/budget" className="group p-6 lg:p-10 bg-white rounded-[2.5rem] border border-neutral-100 hover:shadow-3 transition-all duration-500 overflow-hidden relative">
          ...
          {/* Guests Card */}
          <Link href="/mariage/invites" className="group p-6 lg:p-10 bg-white rounded-[2.5rem] border border-neutral-100 hover:shadow-3 transition-all duration-500 overflow-hidden relative">
            <div className="absolute top-0 end-0 p-8 opacity-5 group-hover:scale-110 transition-transform text-primary">
              <svg className="w-24 h-24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Checklist Card */}
          <Link href="/mariage/checklist" className="group p-6 lg:p-10 bg-white rounded-[2.5rem] border border-neutral-100 hover:shadow-3 transition-all duration-500 overflow-hidden relative">
