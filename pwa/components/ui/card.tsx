...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[2.5rem] border bg-card text-card-foreground shadow-premium transition-all hover:shadow-premium-hover",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-2xl font-black leading-none tracking-tight font-display text-primary",
      className
    )}
    {...props}
  />
