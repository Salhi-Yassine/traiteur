        ...
        <div className="bg-white p-8 md:p-12 rounded-[2rem] border border-neutral-100 shadow-xl shadow-primary/5 max-w-2xl mx-auto my-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <h3 className="font-display text-3xl text-neutral-900 mb-3">
                    {t("budget.assistant.title", "Commençons votre budget magique")}
                </h3>
                <p className="text-[#717171] mb-8 max-w-md mx-auto">
                    {t("budget.assistant.desc", "Dites-nous en plus sur votre mariage et nous générerons une structure budgétaire adaptée aux standards marocains.")}
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 text-left">
                    <div className="space-y-3">
                        <Label className="flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-[#B0B0B0]">
                            <Users size={14} />
                            {t("budget.assistant.guests", "Invités")}
                        </Label>
                        <Input 
                            type="number" 
                            value={guestCount} 
                    ...
                    <div className="space-y-3">
                        <Label className="flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-[#B0B0B0]">
                            <Crown size={14} />
                            {t("budget.assistant.tier", "Prestige")}
                        </Label>
                        <Select value={tier} onValueChange={setTier}>
                            ...
                            <SelectContent className="rounded-xl">
                                ...
                                <SelectItem value="luxury">Luxe Absolu</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </div>
                ...
                >
                    {t("budget.assistant.generate_btn", "Générer mon budget type")}
                </Button>
            </div>
        </div>
    );
