...
> This file is superseded by the multi-file PRD structure introduced in v1.2 (2026-04-18).
> **New location: [`.agent/docs/prd/README.md`](prd/README.md)**

The original single-file PRD is preserved below for historical reference only.
Do not edit this file — update the files in `.agent/docs/prd/` instead.

---

<!-- ARCHIVED v1.1 below — do not edit -->

# Farah.ma — Product Requirements Document (v1.1 — Archived)

> **Version:** 1.1
> **Date:** 2026-03-31
> **Author:** Product & Design Lead
> **Status:** Archived — superseded by prd/ directory
